...
在上图中AbstractFactory、AbstractProductA和AbstractProductB分别个抽象基类，分别派生出用来产生两种实际产品A和B的类厂1和2，经由这两个类厂的CreateProductA和CreateProductB方法使用AbstractProduct所派生出的两类具体产品家族来生产A和B所下辖1-2型产品。

\textbf{Participants 组成}
